...
class ClassRoomValidator {
  ...
  static async postCalendar(req) {
    ...
    if (dates.length != class_session.length) {
      code = 1;
    ...
    if (invalid_class_session.length > 0) {
      code = 1;
