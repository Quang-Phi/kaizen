...
class ClassTypesCoursesModel extends Model {
  static table = "class_types_courses";
  static primaryKey = "id";
  static fillable = ["id", "class_types_id", "courses_id"];
...
module.exports = { ClassTypesCoursesModel };
