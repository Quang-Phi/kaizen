...
class TeachersStatusModel extends Model {
  static table = "teachers_status";
  static primaryKey = "id";
  static fillable = ["id", "value", "created_at", "updated_at"];
...
module.exports = { TeachersStatusModel };
